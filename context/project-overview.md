...
Guests enter through a QR URL containing a party code, receive party-scoped temporary identities, can read the sanitized active queue, and submit song requests through a validated server endpoint. Parties expire after 12 hours; duplicate songs are blocked while queued or playing but may be requested again after completion. Fair rotation is preferred. The initial library target is about 5,000 songs; selected YouTube discoveries may be saved to PocketBase. The future import is restricted to karaoke backing-track YouTube videos, excluding original music videos, ordinary lyric videos, live performances, non-karaoke covers, and unrelated results; song records retain provenance and eligibility metadata for later enforcement.
