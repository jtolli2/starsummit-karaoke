...
class MainActivity : Activity() {
  ...
  private fun render(value: DiagnosticsSnapshot) {
    ...
    diagnostics.text = buildString {
      ...
      append("Controller attempt: ").append(value.controllerAttemptCount).append('\n')
      ...
      append("Controller establishes: ").append(value.controllerEstablishCount).append('\n')
      append("Initial refetch commands: ").append(value.controllerInitialRefetchCount ?: "—").append('\n')
      append("Realtime hint: ").append(value.controllerRealtimeEventRedacted ?: "—").append('\n')
      append("Subscription accepted: ").append(if (value.controllerSubscriptionAccepted) "yes" else "no").append('\n')
      append("Realtime fallback: ").append(value.controllerRealtimeFallbackErrorRedacted ?: "—").append('\n')
      append("Last refetch commands: ").append(value.controllerRefetchCount ?: "—").append('\n')
      append("Last refetch error: ").append(value.controllerRefetchErrorRedacted ?: "—").append('\n')
